...
buttonDashboardBudgetEdit.addEventListener("click", () => {
  ...
  let popup = new Popup(250, "auto", "Update Budget", html, {
    cancelText: "Dismiss",
    confirmText: "-",
    page: "dashboard",
  });
  ...
  document
    .getElementById("popup-button-budget")
  ...
  document
    .getElementById("popup-button-income")
    .addEventListener("click", () => {
      popup.hide();
      showIncomePopup();
    });
...
buttonDashboardWatchlistAdd.addEventListener("click", () => {
  try {
    ...
    let popup = new Popup(240, "auto", "Add To Watchlist", html, {
      confirmText: "Add",
      page: "dashboard",
    });
    popup.show();
    ...
    popup.on("confirm", async () => {
      ...
      if (!empty(symbol)) {
        ...
        let type = popupChoiceCrypto.classList.contains("active")
          ? "crypto"
          : "stock";
